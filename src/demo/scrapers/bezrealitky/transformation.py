...
import pandas as pd
from src.demo.scrapers.base_transformation import BaseTransformation, TransformationError
...
class BezrealitkyTransformation(BaseTransformation):
    ...
    def add_new_columns(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        df_copy[['region', 'city', 'city_part', 'street']] = df_copy.apply(self._parse_address, axis=1, result_type='expand')
